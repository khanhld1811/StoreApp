...
//        FirebaseUser user = FirebaseAuth.getInstance().getUserId();
//        if (user != null) {
//            DatabaseReference dbRef = FirebaseDatabase.getInstance().getReference();
//            dbRef.child("users").child(user.getUid()).setValue(token);
//            Log.d(TAG, "sendRegistrationTokenToServer: NEW TOKEN: " + token );
//        }
//    }
//
